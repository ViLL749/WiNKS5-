...
#
#         # Список задач слева (добавлен заголовок и шрифты)
#         left_panel = QtWidgets.QWidget()
#         left_vbox = QtWidgets.QVBoxLayout(left_panel)
#         # Заголовок списка задач
#         title_label = QtWidgets.QLabel("Список задач")
#         title_font = QtGui.QFont("Comic Sans MS", 12)
#         title_label.setFont(title_font)
#         title_label.setAlignment(QtCore.Qt.AlignCenter)
#         left_vbox.addWidget(title_label)
#
#         self.task_list = TaskListWidget()
#         # Применяем шрифт Comic Sans к виджету списка
#         list_font = QtGui.QFont("Comic Sans MS", 10)
#         self.task_list.setFont(list_font)
#         left_vbox.addWidget(self.task_list)
#
